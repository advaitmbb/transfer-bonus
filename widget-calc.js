(function () {
  ...
  style.textContent = [
    ...
    '.mbc-inp{width:100%;padding:15px 70px 15px 24px;border-radius:100px;border:2px solid #1a2b3c;background:#fff;color:#1a2b3c;font-family:"Fraunces",serif;font-size:1.6rem;font-weight:700;outline:none;transition:border-color .15s}',
    '.mbc-inp:focus{border-color:#38b6ff}',
    '.mbc-inp::placeholder{color:#d0dae3;font-size:1rem;font-family:"Inter",sans-serif;font-weight:400}',
    '.mbc-inp-suf{position:absolute;right:24px;top:50%;transform:translateY(-50%);font-size:.67rem;font-weight:700;letter-spacing:.08em;text-transform:uppercase;color:#a0b0be;pointer-events:none}',
