(function () {
  ...
  style.textContent = [
    ...
    '.mbb-card{background:#fff;border-radius:20px;padding:26px 24px 22px;box-shadow:0 2px 16px rgba(26,43,60,.07);display:flex;flex-direction:column;gap:0;transition:transform .2s ease,box-shadow .2s ease;position:relative;overflow:hidden}',
    ...
    '.mbb-tooltip{display:none;position:absolute;bottom:calc(100% + 6px);left:50%;transform:translateX(-50%);background:#1a2b3c;color:#fff;font-size:.72rem;font-weight:400;line-height:1.4;padding:7px 10px;border-radius:8px;white-space:nowrap;z-index:10;pointer-events:none}',
